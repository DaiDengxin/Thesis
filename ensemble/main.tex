...
\usepackage{booktabs}     % for hline of different width 
\usepackage{times}
\usepackage{epsfig}
\usepackage{graphicx}
\usepackage{amsmath}
...
\title{Unsupervised High-level Feature Learning by Ensemble Projection for Semi-supervised Image 
...
%             \emph{Present address:} of F. Author  %  if needed
           \and
           Luc Van Gool \at
               Computer Vision Lab, ETH Zurich \& PSI - VISICS, KU Leuven\\
              Tel.: +41 44 63 26578 \\
              Fax:  +41 44 63 21199\\
...
\begin{abstract}
  This paper investigates the problem of semi-supe\-rvised image
  classification and image clustering. Unlike previous methods to
  develop sophisticated classifier models, our method learns a new
  image representation from all available data (labeled and unlabeled)
  by exploiting the patterns of data distribution in a novel
  manner. Particularly, a rich set of visual prototypes are sampled
  from all available data, and are taken as surrogate classes to train
  discriminative classifiers; images are projected (classified) via
  the classifiers and the projected values (similarities to the
  prototypes) are stacked to build a feature vector. The training
 ...
 diverse classifiers. The method is dubbed Ensemble
  ...
  \keywords{Semi-supervised Image Classification \and Image Clustering
    \and High-level Feature Learning \and Ensemble Learning \and Ensemble Projection \and CNN
    Features}
...
\includegraphics[width=0.24\linewidth, height=32mm]{./21_baseline-crop.pdf}& 
\includegraphics[width=0.24\linewidth, height=32mm]{./25_baseline-crop.pdf}& 
...
\includegraphics[width=0.24\linewidth, height=32mm]{./101_baseline-crop.pdf}& 
\includegraphics[width=0.24\linewidth, height=32mm]{./event8_baseline-crop.pdf}& 
\includegraphics[width=0.24\linewidth, height=32mm]{./indoor_baseline-crop.pdf}&  
...
\includegraphics[width=0.24\linewidth, height=32mm]{./Precision_15_transductive-crop.pdf}& 
\includegraphics[width=0.24\linewidth, height=32mm]{./Precision_21_transductive-crop.pdf}& 
\includegraphics[width=0.24\linewidth, height=32mm]{./Precision_25_transductive-crop.pdf}& 
\includegraphics[width=0.24\linewidth, height=32mm]{./Precision_building25_transductive-crop.pdf}   \\
\scriptsize{\text{(a) Scene-15}} & \scriptsize{\text{ (b) LandUse-21}} & \scriptsize{\text{(c) Texture-25}} & \scriptsize{\text{(d) Building-25}}  \\


\includegraphics[width=0.24\linewidth, height=32mm]{./Precision_101_transductive-crop.pdf}& 
\includegraphics[width=0.24\linewidth, height=32mm]{./Precision_event8_transductive-crop.pdf}& 
\includegraphics[width=0.24\linewidth, height=32mm]{./Precision_indoor_transductive-crop.pdf}& 
...
\begin{tabular}{cc}
\toprule
\multicolumn{1}{c}{Methods} \\ \midrule
\emph{k}-NN   \\
\emph{k}-NN + \bf{EP}  \\
LR     \\
LR + \bf{EP} \\  
...
\begin{tabular}{cc}
\toprule
\multicolumn{1}{c}{Scene-15} \\ \midrule
62.4 (1.4) \\
75.6 (0.6) \\
73.0 (1.2) \\
\textbf{80.0} (0.8) \\
...
\begin{tabular}{cc}
\toprule
\multicolumn{1}{c}{LandUse-21} \\ \midrule
69.6 (1.0) \\
75.6 (1.2) \\
\underline{78.0} (0.8) \\
\textbf{80.6} (1.7) \\
...
\begin{tabular}{cc}
\toprule
\multicolumn{1}{c}{Indoor-67} \\ \midrule
21.1 (0.7) \\
26.6 (0.6) \\
31.9 (0.4) \\
\textbf{36.6} (0.6) \\
...
\begin{tabular}{cc}
\toprule
\multicolumn{1}{c}{STL-10} \\ \midrule
55.9 (2.1) \\
65.6 (1.5) \\
65.4 (1.3) \\
73.0 (1.2) \\
...
\begin{figure*} 
  \centering
   $ \begin{array}{cccc}
\includegraphics[width=0.32\linewidth, height=40mm]{./self_stl10_knn-crop.pdf}& 
\includegraphics[width=0.32\linewidth, height=40mm]{./self_stl10_LR-crop.pdf}& 
\includegraphics[width=0.32\linewidth, height=40mm]{./self_stl10_SVM-crop.pdf} \\
