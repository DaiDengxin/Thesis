...
The promise of unsupervised feature learning is that if an algorithm can learn from ``unlabeled" data, then the learning can easily be applied to massive amounts of data. The idea is also flexible, as the learned feature representation can be directly injected to any standard vision algorithms.  In this chapter, we develop a novel feature learning algorithm, and evaluate its efficacy on semi-supervised image classification and image clustering.  
...
%      the Scene-15 dataset~\citep{lazebnik:cvpr06}, for varying training
