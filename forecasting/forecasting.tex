\chapter{Performance Prediction:  Succeed or Fail?}
...
\begin{figure} 
  ...
  \scalebox{0.93}{
   $ \begin{array}{cccc}
\includegraphics[width=0.3\linewidth]{./forecasting/figs/fig1/google_concrete_441.jpg} & 
\includegraphics[width=0.3\linewidth]{./forecasting/figs/fig1/google_concrete_476.jpg}&
\includegraphics[width=0.3\linewidth]{./forecasting/figs/fig1/bing2_food_19.jpg} \\
\text{(a) \textcolor{red}{0.84}} & \text{(b) \textcolor{red}{0.80}} & \text{(c) \textcolor{red}{0.72}} \\
% \hspace{-3mm}
...
\text{(d) \textcolor{red}{0.57}} & \text{(e) \textcolor{red}{0.54}} & \text{(f) \textcolor{red}{0.51}} \\

\includegraphics[width=0.3\linewidth]{./forecasting/figs/fig1/flickr_biscuit_194.jpg} & 
\includegraphics[width=0.3\linewidth]{./forecasting/figs/fig1/flickr_brick_233.jpg}&
\includegraphics[width=0.3\linewidth]{./forecasting/figs/fig1/flickr_chips_144.jpg} \\
\text{(g) \textcolor{blue}{0.41}} & \text{(h) \textcolor{blue}{0.35}} & \text{(i) \textcolor{blue}{0.32}} \\
\includegraphics[width=0.3\linewidth]{./forecasting/figs/fig1/flickr_Fabric_471.jpg} & 
\includegraphics[width=0.3\linewidth]{./forecasting/figs/fig1/flickr_brick_215.jpg}&
\includegraphics[width=0.3\linewidth]{./forecasting/figs/fig1/bing2_food_75.jpg} \\
\text{(j) \textcolor{blue}{0.28}} & \text{(k) \textcolor{blue}{0.18}} & \text{(l) \textcolor{blue}{0.14}} \\
% \hspace{-3mm}
...
texture synthesis as `ETS' in the remainder of this work. Even if the
...
\begin{figure} [!t]
  \centering
   $ \begin{array}{cccc}
\hspace{-1.5mm}
\includegraphics[width=0.23\linewidth]{./forecasting/figs/dataset/87.jpg} & 
\hspace{-3mm}
\includegraphics[width=0.23\linewidth]{./forecasting/figs/dataset/flickr_cardboard_211.jpg} & 
\hspace{-3mm}
\includegraphics[width=0.23\linewidth]{./forecasting/figs/dataset/google_flower_169.jpg} \\ 
\hspace{-1.5mm}
\includegraphics[width=0.32\linewidth]{./forecasting/figs/dataset/87syn.jpg} & 
\hspace{-3mm}
\includegraphics[width=0.32\linewidth]{./forecasting/figs/dataset/flickr_cardboard_211_m.jpg} & 
\hspace{-3mm}
\includegraphics[width=0.32\linewidth]{./forecasting/figs/dataset/google_flower_169_q.jpg} \\ 
...
% analysis/synthesis~\citep{Portilla:2000:IJCV}.
...
% self-similarity feature~\citep{self:similarity}. We averaged the 
% self-similarity
% vectors of all pixels in an image to represent its self-similarity.

% \textbf{Complexity}. We follow~\citep{image:interestingness} to measure
...
% to be. We measure colorfulness as proposed by Datta and Wang~\citep{aesthetic:eccv06}, \ie
...
% Canny edge detector~\citep{canny:edge} for edge detection, with the
...
% shape descriptor'~\citep{hayko:eccv2010} which captures the local shape
...
% \textbf{structures} cf.~\citep{tsmoothing2012}: texture and main
...
%already for image quality prediction~\citep{blind:quality:cvpr11}.
...
\scalebox{0.9}{
   $ \begin{array}{cccc}
\hspace{-1.5mm}
\includegraphics[width=0.33\linewidth]{./forecasting/figs/repet/1.jpg} & 
\hspace{-2mm}
\includegraphics[width=0.33\linewidth]{./forecasting/figs/repet/forest.jpg} & 
\hspace{-2mm}
\includegraphics[width=0.33\linewidth]{./forecasting/figs/repet/273.jpg} \\ 
\text{(a) 8.82} & \text{(b) 3.84} & \text{(c) 3.73} \\
\hspace{-1.5mm}
\includegraphics[width=0.33\linewidth]{./forecasting/figs/repet/439.jpg} & 
\hspace{-2mm}
\includegraphics[width=0.33\linewidth]{./forecasting/figs/repet/flower2.jpg} & 
\hspace{-2mm}
\includegraphics[width=0.33\linewidth]{./forecasting/figs/repet/832.jpg} \\ 
\text{(d) 3.12} & 
\text{(e) 1.80} & 
\text{(f) 1.63}  \\
...
% \textbf{Edge coverage}.  
% \textbf{Attributes} lined or circled~\citep{semantic:texture}? 
...
dataset~\citep{UIUC:Texture} delivered the positive samples (textures),
and the 15-Scene dataset~\citep{lazebnik:cvpr06} the negative ones
(objects/scenes). Linear SVMs were used as the classifier with
GIST~\citep{gist} as the feature. The classification score is taken as
`textureness'.
...
matrices~\citep{texture:analysis}, but is low-level and quite noise
...
% ~\citep{low:rank:texture:ijcv12}. 

\begin{figure} [!t]
  \centering \scalebox{0.9}{
   $ \begin{array}{cccc}
\hspace{-1.5mm}
\includegraphics[width=0.33\linewidth]{./forecasting/figs/repetitiveness/60.jpg} & 
\hspace{-2mm} 
\includegraphics[width=0.33\linewidth]{./forecasting/figs/repetitiveness/bing2_floor_201.jpg} & 
\hspace{-2mm}
\includegraphics[width=0.33\linewidth]{./forecasting/figs/repetitiveness/bing2_animal_19.jpg} \\ 
\text{(a) 76.4} &
 \text{(b) 70.5} & 
\text{(c) 66.5}  \\
\hspace{-1.5mm}
\includegraphics[width=0.33\linewidth]{./forecasting/figs/repetitiveness/bing2_floor_78.jpg} & 
\hspace{-2mm}
\includegraphics[width=0.33\linewidth]{./forecasting/figs/repetitiveness/10rep.jpg} & 
\hspace{-2mm}
\includegraphics[width=0.33\linewidth]{./forecasting/figs/repetitiveness/bing2_floor_24.jpg} \\ 
\text{(d) 49.7} & 
\text{(e) 39.4} & 
\text{(f) 32.4}  \\
% \hspace{-1.5mm}
...
appearance~\citep{WLKT09}. FFT features, of which the power spectrum is
directly related to auto-correlation, have been used very early
on~\citep{vangool83, texture:analysis, liu:texture:96}. For periodic patterns, the
...
(Figure~\ref{te:fig:repet}), that is defined in the spatial domain.
...
\begin{figure} 
  \centering \scalebox{0.9}{
   $ \begin{array}{cccc}
\hspace{-1.5mm}
\includegraphics[width=0.33\linewidth]{./forecasting/figs/regularity/403.jpg} & 
\hspace{-2mm} 
\includegraphics[width=0.33\linewidth]{./forecasting/figs/regularity/13.jpg} & 
\hspace{-2mm}
\includegraphics[width=0.33\linewidth]{./forecasting/figs/regularity/90.jpg} \\ 
\text{(a) 0.22} & \text{(b) 0.14} & \text{(c) 0.12}  \\
\hspace{-1.5mm}
\includegraphics[width=0.33\linewidth]{./forecasting/figs/regularity/57.jpg} & 
\hspace{-2mm}
\includegraphics[width=0.33\linewidth]{./forecasting/figs/regularity/28.jpg} & 
\hspace{-2mm}
\includegraphics[width=0.33\linewidth]{./forecasting/figs/regularity/google_Paper_100.jpg} \\ 
\text{(d) 0.10} & 
\text{(e) 0.08} & 
\text{(f) 0.05}  \\
\end{array}$}
...
Figure~\ref{te:fig:homo}(b) is homogeneous, but not repetitive and not
regular. The texture in Figure~\ref{te:fig:irreg}(f) is homogeneous and
...
Forest~\citep{randomforest} was used for both training tasks due to its
...
\begin{figure*} [!t]
  \centering \scalebox{1}{
   $ \begin{array}{ccccc}
\hspace{-1mm}
\includegraphics[width=0.13\linewidth ]{./forecasting/figs/Fabric/147.jpg} & 
\hspace{-2mm} 
\includegraphics[width=0.13\linewidth]{./forecasting/figs/fig8/bing_foam_150.jpg} & 
\hspace{-2mm}
\includegraphics[width=0.13\linewidth]{./forecasting/figs/Fabric/161.jpg} & 
\hspace{-2mm}
\includegraphics[width=0.13\linewidth]{./forecasting/figs/Fabric/696.jpg} & 
\hspace{-2mm}
\includegraphics[width=0.13\linewidth]{./forecasting/figs/Fabric/flickr_Fabric_75.jpg} \\ 

\hspace{-1.5mm}
\includegraphics[width=0.19\linewidth]{./forecasting/figs/Fabric/147_syn.jpg} & 
\hspace{-3mm} 
\includegraphics[width=0.19\linewidth]{./forecasting/figs/fig8/bing_foam_150_m.jpg} & 
\hspace{-3mm} 
\includegraphics[width=0.19\linewidth]{./forecasting/figs/Fabric/161_syn.jpg} & 
\hspace{-3mm}
\includegraphics[width=0.19\linewidth]{./forecasting/figs/Fabric/696_syn.jpg} & 
\hspace{-3mm}
\includegraphics[width=0.19\linewidth]{./forecasting/figs/Fabric/flickr_Fabric_75_q.jpg} \\ 

% \scriptsize{\text{(a) 0.83, Quilting~\citep{Efros:sig2001}}} & 
% \scriptsize{\text{(b) 0.63, MMRF~\citep{paget:tip98}}} & 
% \scriptsize{\text{(c) 0.54, Phase~\citep{random:phase}}} & 
% \scriptsize{\text{(d) 0.27, Wavelets~\citep{Portilla:2000:IJCV}}} & 
% \scriptsize{\text{(e) 0.12, Quilting~\citep{Efros:sig2001}}}  \\
...
\hspace{-1mm}
\includegraphics[width=0.13\linewidth ]{./forecasting/figs/fig8/google_brick_32.jpg} & 
\hspace{-2mm}
\includegraphics[width=0.13\linewidth]{./forecasting/figs/fig8/flickr_carpet_325.jpg} & 
\hspace{-2mm}
\includegraphics[width=0.13\linewidth]{./forecasting/figs/fig8/bing2_rust_136.jpg} & 
\hspace{-2mm} 
\includegraphics[width=0.13\linewidth]{./forecasting/figs/fig8/bing2_pasta_69.jpg} & 
\hspace{-2mm}
\includegraphics[width=0.13\linewidth]{./forecasting/figs/fig8/bing2_crowd_176.jpg} \\


% \scriptsize{\text{(f) 0.94, Quilting~\citep{Efros:sig2001}}} & 
% \scriptsize{\text{(h) 0.79, Wavelets~\citep{Portilla:2000:IJCV}}} & 
% \scriptsize{\text{(i) 0.78, MMRF~\citep{paget:tip98}}} & 
% \scriptsize{\text{(g) 0.42, MMRF~\citep{paget:tip98}}} & 
% \scriptsize{\text{(j) 0.20, Quilting~\citep{Efros:sig2001}}}  \\
\hspace{-1.5mm}
\includegraphics[width=0.19\linewidth]{./forecasting/figs/fig8/google_brick_32_q.jpg} & 
\hspace{-3mm} 
\includegraphics[width=0.19\linewidth]{./forecasting/figs/fig8/flickr_carpet_325_w.jpg} & 
\hspace{-3mm}
\includegraphics[width=0.19\linewidth]{./forecasting/figs/fig8/bing2_rust_136_m.jpg} & 
\hspace{-3mm} 
\includegraphics[width=0.19\linewidth]{./forecasting/figs/fig8/bing2_pasta_69_q.jpg} & 
\hspace{-3mm}
\includegraphics[width=0.19\linewidth]{./forecasting/figs/fig8/bing2_crowd_176_q.jpg} \\ 
...
\begin{figure} [!t]
  \centering \scalebox{1}{
   $ \begin{array}{cccccc}
\hspace{-1.5mm}
\includegraphics[width=0.26\linewidth ]{./forecasting/figs/best/google_plastic_19.jpg} & 
\hspace{-3mm} 
\includegraphics[width=0.34\linewidth]{./forecasting/figs/best/google_plastic_19_q.jpg} & 
\hspace{-3mm}
\includegraphics[width=0.34\linewidth]{./forecasting/figs/best/google_plastic_19_w.jpg} \\ 
\hspace{-1.5mm}
{\text{(a) exemplar}} & 
\hspace{-3mm}
{\text{(b) suggested (Quilting)}} & 
\hspace{-3mm}
{\text{(c) random (Wavelet)}} \\ 
\\
\hspace{-2.5mm}
\includegraphics[width=0.26\linewidth]{./forecasting/figs/best/bing2_rain_163.jpg} & 
\hspace{-3mm}
\includegraphics[width=0.34\linewidth]{./forecasting/figs/best/bing2_rain_163_m.jpg} & 
\hspace{-3mm}
\includegraphics[width=0.34\linewidth]{./forecasting/figs/best/bing2_rain_163_q.jpg} \\ 
\hspace{-1.5mm}
{\text{(d) exemplar}} & 
\hspace{-3mm}
{\text{(e) suggested (MMRF)}} & 
\hspace{-3mm}
{\text{(f) random (Quilting)}}  \\
\end{array}$ }
...
\hspace{-1mm}
\includegraphics[width=0.19\linewidth]{./forecasting/figs/failure/fp/bing2_crowd_35.jpg} & 
\hspace{-3mm}
%\multirow{2}{c|}{Head 1}
\includegraphics[width=0.29\linewidth]{./forecasting/figs/failure/fp/bing2_crowd_35_m.jpg} & 
\hspace{-3mm}
\includegraphics[width=0.19\linewidth]{./forecasting/figs/failure/fp/bing_hair_263.jpg} & 
\hspace{-3mm}
%\multirow{2}{c|}{Head 1}
\includegraphics[width=0.29\linewidth]{./forecasting/figs/failure/fp/bing_hair_263_q.jpg} \\ 
\hspace{-1mm}
{\text{ (a) 0.65}} & 
\hspace{-3mm}
{\text{ (b) synthesized}  } & 
...
\hspace{-1mm}
\includegraphics[width=0.19\linewidth]{./forecasting/figs/failure/fn/bing2_cloud_40.jpg} & 
\hspace{-3mm}
%\multirow{2}{c|}{Head 1}
\includegraphics[width=0.29\linewidth]{./forecasting/figs/failure/fn/bing2_cloud_40_m.jpg} & 
\hspace{-3mm}
\includegraphics[width=0.19\linewidth]{./forecasting/figs/failure/fn/bing2_rust_10.jpg} & 
\hspace{-3mm}
%\multirow{2}{c|}{Head 1}
\includegraphics[width=0.29\linewidth]{./forecasting/figs/failure/fn/bing2_rust_10_m.jpg} \\ 
\hspace{-1mm}
{\text{ (e) 0.35}} & 
\hspace{-3mm}
{\text{ (f) synthesized}  } & 
...
\begin{figure} 
  \centering
   $ \begin{array}{ccc}
\hspace{-1.5mm}
\includegraphics[width=0.3\linewidth]{./forecasting/figs/scale/flickr_crushed_78.jpg} & 
\hspace{-3mm}
\includegraphics[width=0.3\linewidth]{./forecasting/figs/scale/flickr_crushed_79.jpg} & 
\hspace{-3mm}
\includegraphics[width=0.3\linewidth]{./forecasting/figs/scale/flickr_crushed_80.jpg} \\
\hspace{-1.5mm}
{\text{ (a) 0.22}} & 
\hspace{-3mm}
{\text{ (b) 0.34}} & 
...
% category).  The UIUC texture dataset~\citep{UIUC:Texture}, which
% contains $25$ texture categories, each with $40$ images. Figure~\ref{}
...
% Database~\citep{columbia:texture} and Open-Surface
% dataset~\citep{open:surface} is planned as a future work. The former
...
% useful.
% This trimming shares some similarity with~\citep{dominant:texture:09}
...
% texture dataset~\citep{UIUC:Texture} was used for this task, which
...
% accuracy of Uniform LBP~\citep{lbp:2002}, of synfets, and of their
...
\begin{figure*} [!t]
  \centering
   $ \begin{array}{cccc}
\hspace{-1mm}
\includegraphics[width=0.24\linewidth, height=32mm]{./forecasting/figs/2/2.jpg} & 
\hspace{-3mm}
\includegraphics[width=0.24\linewidth, height=32mm]{./forecasting/figs/2/3.jpg} & 
\hspace{-3mm}
\includegraphics[width=0.24\linewidth, height=32mm]{./forecasting/figs/2/roi_11_rect.pdf} & 
\hspace{-3mm}
\includegraphics[width=0.24\linewidth, height=32mm]{./forecasting/figs/2/22_3.jpg} \\
\hspace{-1mm}
{\text{ (a) RS:0.50, IS:0.19}} & 
\hspace{-3mm}
{\text{ (b) RS:0.40,  IS:0.22}}  &
\hspace{-3mm}
{\text{ (c) RS:0.53,  IS:0.40}} & 
\hspace{-3mm}
{\text{ (d) RS:0.51,  IS:0.23}} \\ 
\end{array}$
...
\begin{figure} [tb]
  \centering
   $ \begin{array}{ccc}
\hspace{-1.5mm}
\includegraphics[width=0.30\linewidth]{./forecasting/figs/roi/roi_2.jpg} & 
\hspace{-3mm}
\includegraphics[width=0.33\linewidth, height=36mm]{./forecasting/figs/roi/2_syn.jpg} & 
\hspace{-3mm}
\includegraphics[width=0.33\linewidth, height=36mm]{./forecasting/figs/roi/2_1_syn.jpg} \\

\hspace{-1.5mm}
{ \text{(a) IS:0.14, RS:0.43}} & 
\hspace{-3mm}
{\text{(b) Synthesized from image}} & 
\hspace{-3mm}
{\text{(c) Synthesized from region}} \\
 
\hspace{-1.5mm}
\includegraphics[width=0.30\linewidth]{./forecasting/figs/roi/roi_1.jpg} & 
\hspace{-3mm}
\includegraphics[width=0.33\linewidth, height=36mm]{./forecasting/figs/roi/1_syn.jpg} & 
\hspace{-3mm}
\includegraphics[width=0.33\linewidth, height=36mm]{./forecasting/figs/roi/1_1_syn.jpg} \\
\hspace{-1.5mm}
{\text{(d) IS:0.13, RS:0.50}} & 
\hspace{-3mm}
{\text{(e) Synthesized from image}} & 
\hspace{-3mm}
{\text{(f) Synthesized from region}} \\ 
