...
%Particularly we use~\citep{arbelaez2011contour,MCG} as our input due to their popularity in many other vision applications. Also options are also possible for our system. 
...
% alignment with MCG~\citep{MCG}, which is
...
\item MCG~\citep{MCG}: a unified framework for
...
\item SCG~\citep{MCG}: the single-resulution,
...
segmentation~\citep{MCG} or semantic
